...
- [Admin Panel](#admin-panel-26-pages)
...
1. **Face Verification** — Upload/capture face photos for admin review
2. **Policy Agreements** — Sign applicable policies (matched by role AND department using AND logic)
3. **Employee Data Form** — Complete 8-section form:
...
2. Set environment variables in the Render dashboard (see [Environment Variables](#environment-variables))
...
3. Build static export: `STATIC_BUILD=1 npx next build`
